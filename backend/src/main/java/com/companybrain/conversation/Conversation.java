...
/**
 * A chat thread, stored as one MongoDB document with its messages embedded: a conversation is
 * always read and written as a whole, and it has no fixed schema to migrate.
 */
...
public class Conversation {
    ...
    /** Username of the employee who owns the conversation. */
    ...
    public static Conversation start(String owner, String firstQuestion) {
